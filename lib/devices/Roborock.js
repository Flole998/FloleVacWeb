...
class Roborock extends MiioVacuum {
    ...
    detectFanSpeeds(msg_ver) {
        ...
        if (this.model.name === "rockrobo.vacuum.v1") {
            delete fanSpeeds[MiioVacuum.FAN_SPEEDS.MOP];
        }
    ...
    */
    ...
    async getCleanRecord(recordId) {
        return await this.sendLocal("get_clean_record", [recordId], {});
    }
    ...
    */
     ...
     */
    async savePersistentData(persistantData) { //TODO: Store in floleVacWeb config
